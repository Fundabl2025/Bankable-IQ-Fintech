            ...
            {(() => {
              ...
              const phases = [
                ...
                },
                {
                  ...
                  metric: isBankable ? `SBSS ${bankableScore}/300 ✓ — bankable threshold crossed` : `SBSS ${bankableScore}/300 — ${160 - bankableScore} pts to bankable`,
                  color: '#3b82f6',
                  cta: '/app/lender-compliance',
                  ctaLabel: isBankable ? 'View Compliance' : 'Start Compliance',
                },
                {
                  num: '03',
                  ...
                  metric: isBankable ? `Full bank access unlocked · 9–12% APR` : `Requires SBSS 160+ (${160 - bankableScore} pts away)`,
                  color: '#f59e0b',
                  cta: '/app/access-funding',
