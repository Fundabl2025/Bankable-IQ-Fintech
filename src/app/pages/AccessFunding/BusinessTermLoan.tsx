...
export function BusinessTermLoan() {
  ...
  const isPreQualified = isProgramPreQualified('business-term-loan');
  const allPrograms = getFundingPrograms();
  const programData = allPrograms.find(p => p.id === 'business-term-loan');

  const quickFacts = [
    { icon: DollarSign, label: 'Max Amount', value: '$10,000,000', color: 'success' },
    { icon: Calendar, label: 'Term', value: '1 to 2 years', color: 'info' },
    { icon: RefreshCw, label: 'Payments', value: 'Weekly or monthly', color: 'info' },
    { icon: CheckCircle2, label: 'Prepayment Penalty', value: 'None', color: 'success' },
    { icon: Clock, label: 'Funding Speed', value: 'Not stated in catalog', color: 'accent' }
  ];

  const qualifications = [
    { label: 'Time in Business', value: '2 years', icon: Building2 },
  ...
  const benefits = [
    'It provides a defined repayment structure with weekly or monthly payment options.',
    'It allows early payoff without penalties.',
    'It can be used to refinance certain existing financing and simplify obligations.'
  ];

  const uniqueBenefits = [
    'Refinance up to 2 loans.',
    'Refinance up to 2 merchant cash advances.',
    'Could report to business credit bureaus.',
  ...
  const faqs = [
    {
      question: 'Can I refinance existing financing?',
      answer: 'Yes, refinancing up to 2 loans may be available.'
    },
    {
      question: 'Can I refinance merchant advances?',
      answer: 'Yes, refinancing up to 2 merchant advances may be available.'
    },
    {
      question: 'Is there a penalty for paying early?',
      answer: 'No, there is no prepayment penalty.'
    }
  ];
    ...
    <div className="flex-1 min-h-screen overflow-auto" style={{ backgroundColor: 'var(--background)' }}>
      <div className="max-w-6xl mx-auto p-8">
        ...
        <FundingProgramHeader
          ...
          description="A lump-sum business loan that is repaid on a weekly or monthly schedule over a defined 1 to 2 year term, with no penalty for paying the loan off early."
          amount="Up to $10M"
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <Card className="p-6 shadow-lg border-2" style={{ borderColor: 'var(--primary-border)' }}>
        ...
        >
          <Card className="p-6 shadow-lg">
            ...
            <p className="leading-relaxed" style={{ color: 'var(--muted-foreground)' }}>
              A lump-sum business loan that is repaid on a weekly or monthly schedule over a defined 1 to 2 year term, with no penalty for paying the loan off early.
            </p>
          </Card>
        </motion.div>
        ...
        >
          <Card className="p-6 shadow-lg border-2" style={{ 
            ...
            <p className="leading-relaxed" style={{ color: 'var(--foreground)' }}>
              Established businesses with strong revenue that need capital for growth, operational needs, or refinancing existing obligations into a more manageable structure.
            </p>
          </Card>
        </motion.div>
          ...
          <Card className="p-6 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {industries.map((industry, index) => (
                ...
                >
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'var(--primary-bg)' }}>
