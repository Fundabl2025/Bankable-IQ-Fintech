...
export function ReceivableFactoring() {
  ...
  const quickFacts = [
    { icon: DollarSign, label: 'Facility Size', value: '$100,000 to $100,000,000', color: 'info' },
    { icon: RefreshCw, label: 'Structure', value: 'Revolving line of credit secured by receivables, availability fluctuates as receivables fluctuate', color: 'info' },
    { icon: TrendingUp, label: 'Advance Rate', value: 'Up to 95% financing of current receivables', color: 'success' },
    { icon: Percent, label: 'Rates', value: 'Starting at Prime + 2%', color: 'info' },
    { icon: Clock, label: 'Funding Speed', value: '7 to 10 days', color: 'info' },
    { icon: CheckCircle2, label: 'Pros', value: 'Scales from $100K to $100M, up to 95% financing of receivables, Prime + 2% pricing starting point, grows with receivable volume, stabilizes cash flow, no minimum FICO is stated', color: 'success' },
  ...
  const benefits = [
    'Facility size can scale from $100,000 to $100,000,000.',
    'Up to 95% financing of receivables is available.',
    'Rates starting at Prime + 2% are stated.',
    'Grows with receivable volume and stabilizes cash flow.',
    'Often positioned with no minimum FICO requirement.'
  ];

  const uniqueBenefits = [
    'Revolving structure that fluctuates with receivables.',
    'High advance rate, up to 95% of current receivables.',
    'Prime-based pricing starting point.',
    'Designed to scale as receivable volume grows.'
  ];

  const qualifications = [
    { label: 'Time in business', value: '1+ year', icon: Calendar },
    { label: 'Credit', value: 'No minimum FICO is stated', icon: Shield },
    { label: 'Revenue', value: '$1,000,000+ in annual sales is stated', icon: DollarSign },
    { label: 'Receivables', value: '$250K+ in A/R is stated in one document, and $100,000+ in A/R on short terms is stated in the other', icon: FileText },
    { label: 'Customers', value: 'Verifiable B2B customers required', icon: Users }
  ];
  ...
  const faqs = [
    {
      ...
      answer: 'It is designed for B2B businesses and is not suitable for B2C, verifiable B2B customers are required.'
    },
    {
      question: 'Why is it called revolving?',
      answer: 'Because availability can increase or decrease as outstanding receivables fluctuate, and the facility is designed to be reused as receivables are collected and verified.'
    },
    {
      question: 'What are the main constraints?',
      answer: 'A/R verification is required, the business must have verifiable B2B customers, and clean financial reporting is required.'
    }
  ];
    ...
    <div className="flex-1 min-h-screen overflow-auto" style={{ backgroundColor: 'var(--background)' }}>
      <div className="max-w-6xl mx-auto p-8">
        ...
        <FundingProgramHeader
          ...
          description="Convert outstanding invoices into immediate working capital with a revolving A/R-secured credit facility."
          amount="Up to $100M"
        ...
        >
          <Card className="p-6 shadow-lg">
            ...
            <p className="leading-relaxed" style={{ color: 'var(--muted-foreground)' }}>
              A revolving credit facility secured by accounts receivable, where businesses can convert outstanding invoices into immediate capital. The available facility adjusts as receivables fluctuate.
            </p>
          </Card>
        </motion.div>
        ...
        >
          <Card className="p-6 shadow-lg border-2" style={{ 
            ...
            <p className="leading-relaxed" style={{ color: 'var(--foreground)' }}>
              B2B businesses with verifiable customers that need to stabilize cash flow and avoid waiting 30, 60, or 90+ days for customer payments.
            </p>
          </Card>
        </motion.div>
      ...
      <FundingApplicationModal
        ...
        programAmount="$100,000 to $100,000,000"
        programType="Receivable Factoring"
      />
